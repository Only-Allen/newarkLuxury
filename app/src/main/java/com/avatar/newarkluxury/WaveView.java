...
public class WaveView extends View {
    ...
    public static final int DEFAULT_BOTTOM_WAVE_COLOR = Color.parseColor("#4EFFFFFF");
    ...
    private int mBottomWaveColor = DEFAULT_BOTTOM_WAVE_COLOR;
    ...
    private void createShader() {
        ...
        LinearGradient lg = new LinearGradient(0, 0, 0, mDefaultWaterLevel, mBottomWaveColor,
                mFrontWaveColor, Shader.TileMode.MIRROR);
